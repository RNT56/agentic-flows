...
Turn shipped work into concise public-facing announcement copy with no unshipped claim and a selected channel.
...
| Sample contract | Ready | `examples/samples/docs/public-announcement.sample.json` covers required inputs and expected outputs. |
