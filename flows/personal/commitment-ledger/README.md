...
Extract commitments from conversations into a durable ledger with source, owner, due date, and status.
...
| Sample contract | Ready | `examples/samples/personal/commitment-ledger.sample.json` covers required inputs and expected outputs. |
| Run evidence | Ready | `examples/runs/commitment-ledger.run.json` includes completed gate and output evidence. |
